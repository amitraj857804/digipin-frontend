            ...
            <div className="space-y-6">
              ...
              <div className="flex gap-4">
                <button
                  ...
                  className="flex-1 px-6 py-3 bg-linear-to-r from-blue-600 to-indigo-600 text-white font-bold rounded-xl shadow-lg hover:shadow-xl hover:scale-105 transition-all flex items-center justify-center gap-3 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
                >
                  {isResolving ? (
                    <>
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-green-200 p-8">
            ...
            <div className="border-t border-gray-200 pt-6">
              <button
                ...
                className="w-full px-6 py-3 bg-linear-to-r from-green-600 to-emerald-600 text-white font-bold rounded-xl shadow-lg hover:shadow-xl hover:scale-105 transition-all flex items-center justify-center gap-3"
              >
