      ...
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="text-center mb-12">
          <div className="relative inline-flex items-center justify-center w-20 h-20 mb-6">
            <div className="absolute inset-0 bg-gradient-to-r from-emerald-600 to-teal-600 rounded-3xl shadow-xl animate-pulse"></div>
            <div className="relative bg-gradient-to-r from-emerald-600 to-teal-600 rounded-3xl p-4 shadow-2xl">
              <Shield className="w-12 h-12 text-white" />
            </div>
          </div>
          <h1 className="text-5xl font-extrabold bg-gradient-to-r from-emerald-600 via-teal-600 to-cyan-600 bg-clip-text text-transparent mb-3">
            AAVA System
          </h1>
              ...
              <div className="bg-white/80 backdrop-blur-sm shadow-2xl rounded-3xl border border-white/50 overflow-hidden">
                ...
                <div className="divide-y divide-gray-100">
                  {verificationResults.map((result, idx) => (
                    <div
                      key={idx}
                      className="px-8 py-6 hover:bg-emerald-50 transition-all duration-300"
                    >
                ...
                <div className="px-8 py-8 space-y-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      placeholder="Enter digital address (e.g., username@domain.add)"
                      className={`w-full px-4 py-4 text-base border-2 rounded-xl outline-none transition-all duration-300 font-mono ${
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-4 py-4 text-base border-2 border-gray-300 rounded-xl outline-none focus:border-emerald-500 focus:ring-4 focus:ring-emerald-100 transition-all duration-300"
                    >
                  ...
                  <div className="bg-gray-50 p-6 rounded-2xl border border-gray-200">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <input
                        ...
                        className="px-4 py-3 text-base border-2 border-gray-300 rounded-xl outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-100 transition-all duration-300"
                      />
                      <input
                        type="number"
                        step="any"
                      ...
                      <button
                        ...
                        className="px-4 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-semibold transition-all duration-300 shadow-lg hover:shadow-xl disabled:bg-gray-400 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                      >
                        {gettingLocation ? (
                          <>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      rows="4"
                      className="w-full px-4 py-4 text-base border-2 border-gray-300 rounded-xl outline-none focus:border-emerald-500 focus:ring-4 focus:ring-emerald-100 transition-all duration-300 resize-y min-h-[120px]"
                    />
