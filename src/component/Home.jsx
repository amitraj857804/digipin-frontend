...
import { MapPin, Plus, Copy, Share2, Eye, Lock, Zap, Users, TrendingUp, CheckCircle2, ArrowRight } from 'lucide-react'
import toast from 'react-hot-toast'

function Home({ onOpenLoginModal, onOpenSignupModal }) {
      ...
      <div className='pt-12 pb-16 px-4 md:px-8 lg:px-12 max-w-7xl mx-auto'>
        <div className='text-center mb-16'>
          <h1 className='text-4xl md:text-5xl font-bold text-gray-900 mb-4'>
            ...
            <span className='bg-gradient-to-r from-blue-600 via-indigo-600 to-blue-700 bg-clip-text text-transparent'> Address Hub</span>
          </h1>
          <p className='text-xl text-gray-600 max-w-2xl mx-auto'>
            Manage, share, and track your digital address all in one place. Get started by creating your unique address or managing existing ones.
          </p>
        </div>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12'>
            ...
            <div className='space-y-6'>
              <div className='flex items-center justify-between'>
                <div>
                  ...
                  <p className='text-gray-600 mt-1'>Your unique identifier for receiving deliveries</p>
                </div>
              ...
              <div className='bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-6 border-2 border-blue-200'>
                <p className='text-gray-600 text-sm font-semibold uppercase tracking-wide mb-2'>Your Address ID</p>
                <div className='flex items-center justify-between'>
              ...
              <div className='flex flex-col sm:flex-row gap-3 pt-4'>
                <button className='flex-1 flex items-center justify-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-semibold rounded-lg hover:shadow-lg hover:scale-105 transition-all'>
          ...
          <div className='space-y-4'>
            ...
            <div className='bg-gradient-to-br from-blue-600 via-indigo-600 to-blue-700 rounded-xl shadow-lg p-6 text-white'>
              <h3 className='font-bold text-lg mb-2'>Create New Address</h3>
              <p className='text-blue-100 text-sm mb-4'>Generate additional digital addresses for different purposes</p>
              <button className='w-full flex items-center justify-center gap-2 px-4 py-2 bg-white bg-opacity-20 hover:bg-opacity-30 font-semibold rounded-lg transition-all'>
        ...
        <div className='bg-white rounded-2xl shadow-lg border border-blue-100 p-8 mb-12'>
          <h2 className='text-3xl font-bold text-gray-900 mb-2'>Create Digital Address</h2>
          <p className='text-gray-600 mb-8'>Generate a new digital address for different needs</p>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
            ...
            <div className='space-y-6'>
              <div>
                ...
                <select className='w-full px-4 py-3 border border-blue-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-600 transition-all'>
              ...
              <div>
                ...
                <input
                  type='text'
                  placeholder='e.g., My Home, Work Place'
              ...
              <button className='w-full px-6 py-3 bg-gradient-to-r from-blue-600 via-indigo-600 to-blue-700 text-white font-bold rounded-lg shadow-lg hover:shadow-xl hover:scale-105 transition-all flex items-center justify-center gap-2'>
            ...
            <div className='flex flex-col justify-center'>
              <div className='bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-6 border-2 border-blue-200'>
                <p className='text-sm font-semibold text-gray-600 uppercase tracking-wide mb-4'>Preview</p>
                <div className='space-y-4'>
                  <div>
                    <p className='text-xs text-gray-500'>Purpose</p>
                    <p className='text-lg font-bold text-gray-900'>Personal - Home Address</p>
                  </div>
                  <div>
                  ...
                  <div className='pt-4 border-t border-blue-200'>
                    <p className='text-xs text-gray-500 mb-2'>Your Generated ID</p>
                    <p className='text-2xl font-bold text-transparent bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text font-mono'>DIP-XXXXXXXXXX</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
          <div className='bg-white rounded-xl shadow-lg border border-blue-100 p-6 hover:shadow-xl transition-all'>
            ...
            <p className='text-gray-600 text-sm'>Share your digital address with anyone safely and securely</p>
          </div>
          ...
          <div className='bg-white rounded-xl shadow-lg border border-blue-100 p-6 hover:shadow-xl transition-all'>
            ...
            <h3 className='text-lg font-bold text-gray-900 mb-2'>Track Activity</h3>
            <p className='text-gray-600 text-sm'>Monitor all deliveries and access requests in real-time</p>
          </div>
          ...
          <div className='bg-white rounded-xl shadow-lg border border-blue-100 p-6 hover:shadow-xl transition-all'>
            ...
            <p className='text-gray-600 text-sm'>Protect your privacy with advanced encryption and controls</p>
          </div>
        </div>
      </div>
    </div>
